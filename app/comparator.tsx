...
const Comparator = () => {
    ...
    const comparerVolumes = () => {
        const volume1 = calculerVolume(
            parseFloat(cylinder1.rayon),
            parseFloat(cylinder1.hauteur)
        )
        const volume2 = calculerVolume(
            parseFloat(cylinder2.rayon),
            parseFloat(cylinder2.hauteur)
        )
    ...
    return (
        <div className="subContainer">
            ...
            <Cylinder
                name="cylinder de départ"
                cylinder={cylinder1}
                handleChange={(e) => handleChange(e, 1)}
            />

            <Cylinder
                name="cylinder de fin"
                cylinder={cylinder2}
            ...
            {resultat && (
                <div>
                    ...
                    <p>
                        Le cylinder 2 fait {resultat.pourcentageComparaison}% du
                        volume du cylinder 1.
                    </p>
                </div>
            )}
        </div>
